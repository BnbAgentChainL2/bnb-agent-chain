...
- web/assets/banner-1500x500.png — 1500 × 500 PNG; near-black #0B0E11, subtle darker hexagonal grid, the exact same logo and a sparse diminishing line of connected dots.

The mark is closed, horizontally symmetrical and contained inside the central 80% circle. There is no text, diamond arrangement, official chain logo, texture, gradient, glow or shadow in either final asset. Zero-alpha pixels have zero RGB to support transparent previews cleanly.
